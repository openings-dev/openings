...
- [x] **Step 1: Audit client requirements**
...
- [x] **Step 2: Preserve document composition**
...
- [x] **Step 2: Minimize the Header client boundary**
...
- [x] **Step 3: Normalize icons and accessibility**
...
- [x] **Step 1: Separate static and interactive children**
...
- [x] **Step 2: Colocate contracts and styles**
...
- [x] **Step 3: Preserve all destinations**
...
- [x] **Step 2: Review accessibility structure**
