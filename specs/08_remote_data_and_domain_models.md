...
- [x] **Step 1: Record exact precedence**
...
- [x] **Step 2: Create focused path builders**
...
- [x] **Step 3: Preserve environment documentation**
...
- [x] **Step 1: Implement one concrete fetch contract**
...
- [x] **Step 2: Preserve bounded batch behavior**
...
- [x] **Step 1: Separate pure index operations**
...
- [x] **Step 2: Separate artifact reads**
...
- [x] **Step 3: Keep one page-query facade**
...
- [x] **Step 1: Centralize unknown-value readers**
...
- [x] **Step 2: Separate dataset loading from summaries**
...
- [x] **Step 3: Remove duplicated normalization**
