...
- [x] **Step 1: Preserve the verified document map**
...
- [x] **Step 2: Separate parsing from lookup**
...
- [x] **Step 3: Remove the broad module**
...
- [x] **Step 1: Decompose Markdown rendering**
...
- [x] **Step 2: Keep the page factory server-only**
...
- [x] **Step 1: Use one route composition contract**
