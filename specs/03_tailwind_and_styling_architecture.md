...
- [x] **Step 1: Classify global rules**
...
- [x] **Step 2: Remove only duplicated global behavior**
...
- [x] **Step 1: Separate variants from fixed classes**
...
- [x] **Step 2: Preserve class order and merging**
...
- [x] **Step 3: Remove empty style modules**
...
- [x] **Step 1: Compare utility coverage**
...
- [x] **Step 2: Search unsupported styling**
