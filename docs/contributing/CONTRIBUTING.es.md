...
Usa [`openings-dev/data`](https://github.com/openings-dev/data) para:
...
Al participar, aceptas seguir el [Código de conducta](https://github.com/openings-dev/openings/blob/main/CODE_OF_CONDUCT.md).
