...
```md
[Ver las vacantes de esta comunidad en openings.dev](https://openings.dev/communities/OWNER/REPO)
```

## Badge para el README

```md
[![Vacantes abiertas en openings.dev](https://img.shields.io/badge/openings.dev-open_jobs-111827?logo=github)](https://openings.dev/communities/OWNER/REPO)
```
