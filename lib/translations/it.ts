...
export const itTranslations: TranslationMessages = {
  ...
  communities: {
    ...
    list: {
      summary: "{count} community trovate",
      emptyTitle: "Nessuna community per i filtri correnti",
      emptyDescription: "Modifica paese o regione per ampliare i risultati.",
      repositoryLabel: "Repository",
      countryLabel: "Paese",
      regionLabel: "Regione",
      opportunitiesCount: "{count} opportunità aperte",
  ...
  users: {
    ...
    list: {
      summary: "{count} utenti trovati",
      emptyTitle: "Nessun utente per i filtri correnti",
      emptyDescription: "Modifica paese o regione per ampliare i risultati.",
      handleLabel: "Utente",
      countryLabel: "Paese",
      regionLabel: "Regione",
      opportunitiesCount: "{count} opportunità aperte",
      openUser: "Apri profilo",
    },
  },
  opportunities: {
    header: {
    ...
    status: {
      ariaLabel: "Stato dello snapshot delle opportunità",
      title: "Ultimo aggiornamento API",
      opportunitiesFound: "{count} opportunità trovate",
    ...
    filters: {
      ...
      locationSectionLabel: "Posizione",
      ...
      seniorityPlaceholder: "Aggiungi seniority",
    ...
    card: {
      statusOpen: "Aperta",
      detailsLabel: "Dettagli opportunità",
      closeDetails: "Chiudi dettagli",
      postedAt: "Pubblicata: {date}",
      updatedAt: "Aggiornata: {date}",
      openOriginal: "Apri annuncio originale",
      share: "Condividi opportunità",
      shareCopied: "Link dell'opportunità copiato.",
      shareFailed: "Impossibile condividere questa opportunità.",
  ...
  documents: {
    ...
    maintainers: {
      title: "Per maintainer",
      description:
        "Link canonici, snippet README, badge e testi di outreach per le community elencate.",
    },
    contributing: {
      title: "Contribuire",
      description:
