    ...
    <div className="mx-auto w-full max-w-[90rem] px-4 pb-12 pt-10 sm:px-6 sm:pt-14 lg:px-8 xl:px-10">
      ...
      >
        <ol className="grid gap-3 sm:grid-cols-3">
          ...
          <li className="rounded-card border border-line bg-surface p-5"><Check className="size-5 text-positive-foreground" aria-hidden="true" /><code className="font-mono mt-3 block text-sm text-foreground">3 · /design-system</code><span className="mt-2 block text-xs leading-5 text-muted-foreground"><LocalizedCopy select={(messages) => messages.designSystem.description} /></span></li>
        </ol>
